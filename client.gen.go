...
type ClientInterface interface {
	...
	// AIOnboardingChatWithBody request with any body
	AIOnboardingChatWithBody(ctx context.Context, teamName string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	// OnboardPlatformDestination request
	OnboardPlatformDestination(ctx context.Context, teamName TeamName, reqEditors ...RequestEditorFn) (*http.Response, error)

	// GetPlatformDestinationStatus request
	GetPlatformDestinationStatus(ctx context.Context, teamName TeamName, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	// GetSettings request
	GetSettings(ctx context.Context, teamName TeamName, reqEditors ...RequestEditorFn) (*http.Response, error)

	// UpdateSettingsWithBody request with any body
	UpdateSettingsWithBody(ctx context.Context, teamName TeamName, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	UpdateSettings(ctx context.Context, teamName TeamName, body UpdateSettingsJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) AIOnboardingChatWithBody(ctx context.Context, teamName string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewAIOnboardingChatRequestWithBody(c.Server, teamName, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) AIOnboardingNewConversationWithBody(ctx context.Context, teamName string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewAIOnboardingNewConversationRequestWithBody(c.Server, teamName, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) OnboardPlatformDestination(ctx context.Context, teamName TeamName, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewOnboardPlatformDestinationRequest(c.Server, teamName)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) GetPlatformDestinationStatus(ctx context.Context, teamName TeamName, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetPlatformDestinationStatusRequest(c.Server, teamName)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) GetSettings(ctx context.Context, teamName TeamName, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetSettingsRequest(c.Server, teamName)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) UpdateSettingsWithBody(ctx context.Context, teamName TeamName, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewUpdateSettingsRequestWithBody(c.Server, teamName, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) UpdateSettings(ctx context.Context, teamName TeamName, body UpdateSettingsJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewUpdateSettingsRequest(c.Server, teamName, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewAIOnboardingChatRequest calls the generic AIOnboardingChat builder with application/json body
func NewAIOnboardingChatRequest(server string, teamName string, body AIOnboardingChatJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewAIOnboardingChatRequestWithBody(server, teamName, "application/json", bodyReader)
}

// NewAIOnboardingChatRequestWithBody generates requests for AIOnboardingChat with any type of body
func NewAIOnboardingChatRequestWithBody(server string, teamName string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/teams/%s/ai-onboarding/chat", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewAIOnboardingNewConversationRequest calls the generic AIOnboardingNewConversation builder with application/json body
func NewAIOnboardingNewConversationRequest(server string, teamName string, body AIOnboardingNewConversationJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewAIOnboardingNewConversationRequestWithBody(server, teamName, "application/json", bodyReader)
}

// NewAIOnboardingNewConversationRequestWithBody generates requests for AIOnboardingNewConversation with any type of body
func NewAIOnboardingNewConversationRequestWithBody(server string, teamName string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
// NewOnboardPlatformDestinationRequest generates requests for OnboardPlatformDestination
func NewOnboardPlatformDestinationRequest(server string, teamName TeamName) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/teams/%s/platform/onboard", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewGetPlatformDestinationStatusRequest generates requests for GetPlatformDestinationStatus
func NewGetPlatformDestinationStatusRequest(server string, teamName TeamName) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/teams/%s/platform/status", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewGetSettingsRequest(server string, teamName TeamName) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/teams/%s/settings", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewUpdateSettingsRequest(server string, teamName TeamName, body UpdateSettingsJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewUpdateSettingsRequestWithBody(server, teamName, "application/json", bodyReader)
}

// NewUpdateSettingsRequestWithBody generates requests for UpdateSettings with any type of body
func NewUpdateSettingsRequestWithBody(server string, teamName TeamName, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	// AIOnboardingChatWithBodyWithResponse request with any body
	AIOnboardingChatWithBodyWithResponse(ctx context.Context, teamName string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*AIOnboardingChatResponse, error)
	...
	// OnboardPlatformDestinationWithResponse request
	OnboardPlatformDestinationWithResponse(ctx context.Context, teamName TeamName, reqEditors ...RequestEditorFn) (*OnboardPlatformDestinationResponse, error)

	// GetPlatformDestinationStatusWithResponse request
	GetPlatformDestinationStatusWithResponse(ctx context.Context, teamName TeamName, reqEditors ...RequestEditorFn) (*GetPlatformDestinationStatusResponse, error)
	...
	GetSettingsWithResponse(ctx context.Context, teamName TeamName, reqEditors ...RequestEditorFn) (*GetSettingsResponse, error)

	// UpdateSettingsWithBodyWithResponse request with any body
	UpdateSettingsWithBodyWithResponse(ctx context.Context, teamName TeamName, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdateSettingsResponse, error)

	UpdateSettingsWithResponse(ctx context.Context, teamName TeamName, body UpdateSettingsJSONRequestBody, reqEditors ...RequestEditorFn) (*UpdateSettingsResponse, error)
...
type RenewPlatformActivationResponse struct {
	...
	JSON205      *RenewPlatformActivation205Response
	JSON400      *BadRequest
	JSON404      *NotFound
	JSON429      *TooManyRequests
	JSON500      *InternalError
...
type AIOnboardingChatResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *AIOnboardingChat200Response
	JSON400      *BadRequest
	JSON401      *RequiresAuthentication
	JSON403      *Forbidden
	JSON404      *NotFound
...
// Status returns HTTPResponse.Status
func (r AIOnboardingChatResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
type AIOnboardingNewConversationResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *AIOnboardingNewConversation200Response
	JSON400      *BadRequest
	JSON401      *RequiresAuthentication
	JSON403      *Forbidden
	JSON404      *NotFound
...
// Status returns HTTPResponse.Status
func (r AIOnboardingNewConversationResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
type OnboardPlatformDestinationResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *PlatformDestTenant
	JSON201      *PlatformDestTenant
	JSON400      *BadRequest
	JSON401      *RequiresAuthentication
	JSON403      *Forbidden
	JSON500      *InternalError
...
// Status returns HTTPResponse.Status
func (r OnboardPlatformDestinationResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r OnboardPlatformDestinationResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type GetPlatformDestinationStatusResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *PlatformDestTenant
	JSON401      *RequiresAuthentication
...
// Status returns HTTPResponse.Status
func (r GetPlatformDestinationStatusResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r GetPlatformDestinationStatusResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type RegisterUserResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON201      *RegisterUser201Response
	JSON400      *BadRequest
	JSON404      *NotFound
	JSON429      *TooManyRequests
	JSON500      *InternalError
...
// AIOnboardingChatWithBodyWithResponse request with arbitrary body returning *AIOnboardingChatResponse
func (c *ClientWithResponses) AIOnboardingChatWithBodyWithResponse(ctx context.Context, teamName string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*AIOnboardingChatResponse, error) {
	rsp, err := c.AIOnboardingChatWithBody(ctx, teamName, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) AIOnboardingChatWithResponse(ctx context.Context, teamName string, body AIOnboardingChatJSONRequestBody, reqEditors ...RequestEditorFn) (*AIOnboardingChatResponse, error) {
	rsp, err := c.AIOnboardingChat(ctx, teamName, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseAIOnboardingChatResponse(rsp)
...
func (c *ClientWithResponses) AIOnboardingNewConversationWithBodyWithResponse(ctx context.Context, teamName string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*AIOnboardingNewConversationResponse, error) {
...
func (c *ClientWithResponses) AIOnboardingNewConversationWithResponse(ctx context.Context, teamName string, body AIOnboardingNewConversationJSONRequestBody, reqEditors ...RequestEditorFn) (*AIOnboardingNewConversationResponse, error) {
...
// OnboardPlatformDestinationWithResponse request returning *OnboardPlatformDestinationResponse
func (c *ClientWithResponses) OnboardPlatformDestinationWithResponse(ctx context.Context, teamName TeamName, reqEditors ...RequestEditorFn) (*OnboardPlatformDestinationResponse, error) {
	rsp, err := c.OnboardPlatformDestination(ctx, teamName, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseOnboardPlatformDestinationResponse(rsp)
}

// GetPlatformDestinationStatusWithResponse request returning *GetPlatformDestinationStatusResponse
func (c *ClientWithResponses) GetPlatformDestinationStatusWithResponse(ctx context.Context, teamName TeamName, reqEditors ...RequestEditorFn) (*GetPlatformDestinationStatusResponse, error) {
	rsp, err := c.GetPlatformDestinationStatus(ctx, teamName, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGetPlatformDestinationStatusResponse(rsp)
}
...
func (c *ClientWithResponses) GetSettingsWithResponse(ctx context.Context, teamName TeamName, reqEditors ...RequestEditorFn) (*GetSettingsResponse, error) {
	rsp, err := c.GetSettings(ctx, teamName, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) UpdateSettingsWithBodyWithResponse(ctx context.Context, teamName TeamName, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdateSettingsResponse, error) {
	rsp, err := c.UpdateSettingsWithBody(ctx, teamName, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) UpdateSettingsWithResponse(ctx context.Context, teamName TeamName, body UpdateSettingsJSONRequestBody, reqEditors ...RequestEditorFn) (*UpdateSettingsResponse, error) {
	rsp, err := c.UpdateSettings(ctx, teamName, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseUpdateSettingsResponse(rsp)
...
func ParseRenewPlatformActivationResponse(rsp *http.Response) (*RenewPlatformActivationResponse, error) {
	...
	case strings.Contains(rsp.Header.Get("Content-Type"), "json") && rsp.StatusCode == 205:
		var dest RenewPlatformActivation205Response
		if err := json.Unmarshal(bodyBytes, &dest); err != nil {
			return nil, err
		}
		response.JSON205 = &dest
...
// ParseAIOnboardingChatResponse parses an HTTP response from a AIOnboardingChatWithResponse call
func ParseAIOnboardingChatResponse(rsp *http.Response) (*AIOnboardingChatResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &AIOnboardingChatResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseAIOnboardingNewConversationResponse parses an HTTP response from a AIOnboardingNewConversationWithResponse call
func ParseAIOnboardingNewConversationResponse(rsp *http.Response) (*AIOnboardingNewConversationResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &AIOnboardingNewConversationResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
	...
	switch {
	case strings.Contains(rsp.Header.Get("Content-Type"), "json") && rsp.StatusCode == 200:
		var dest AIOnboardingNewConversation200Response
		if err := json.Unmarshal(bodyBytes, &dest); err != nil {
			return nil, err
		}
		response.JSON200 = &dest
...
// ParseOnboardPlatformDestinationResponse parses an HTTP response from a OnboardPlatformDestinationWithResponse call
func ParseOnboardPlatformDestinationResponse(rsp *http.Response) (*OnboardPlatformDestinationResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &OnboardPlatformDestinationResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseGetPlatformDestinationStatusResponse parses an HTTP response from a GetPlatformDestinationStatusWithResponse call
func ParseGetPlatformDestinationStatusResponse(rsp *http.Response) (*GetPlatformDestinationStatusResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &GetPlatformDestinationStatusResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
func ParseRegisterUserResponse(rsp *http.Response) (*RegisterUserResponse, error) {
	...
	switch {
	case strings.Contains(rsp.Header.Get("Content-Type"), "json") && rsp.StatusCode == 201:
		var dest RegisterUser201Response
		if err := json.Unmarshal(bodyBytes, &dest); err != nil {
			return nil, err
		}
		response.JSON201 = &dest
